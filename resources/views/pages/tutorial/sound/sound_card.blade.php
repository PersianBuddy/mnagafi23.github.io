        ...
        <div class="row">
            ...
            <div class="col-sm-9 page-content">
                 ...
                 <ul class="custom-list">
                     ...
                     <li><a href=""><b>پورت ‌MID/Joystick</b></a> : پورت <b>۱۵ پینی</b> است (پورت زرد رنگ در تصویر) برای اتصال کنترل‌کننده‌ی بازی‌ها  (Joystick) یا کیبورد به کارت صدا استفاده می‌شود.</li>
                     <li><a href=""><b>پورت Firewire</b></a> : در برخی از کارت‌های صدا با کیفیت بالا قرار داده شده است و برای اتصال دستگا‌ه‌هایی مانند <b>دوربین دیجیتال</b> به سیستم مورد استفاده قرار می‌گیرد.</li>
                 </ul>
