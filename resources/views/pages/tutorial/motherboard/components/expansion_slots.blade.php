...
@section('title')
انواع اسلات توسعه و کاربرد آن‌ها
@endsection

@section('description')
به کانکتور‌های باریک بروی مادربورد که امکان نصب کارت‌های توسعه بروی سیستم را فراهم می‌کنند اسلات توسعه می‌گویند. | کارت‌های قابل نصب بروی هر اسلات توسعه کدامند؟
@endsection
            ...
            <div class="col-sm-9 page-content">
                 ...
                 <div id="expansion-slot-type">
                    <h4>انواع اسلات توسعه</h4>
                     <p>
                        در زیر انواع <b><a href="{{url('tutorial/other/bus-چیست')}}">گذرگاه</a> هایی</b> که قطعات از طریق اسلات های توسعه با آن‌ها ارتباط برقرار می‌کنند مورد بررسی قرار داده شده است.
