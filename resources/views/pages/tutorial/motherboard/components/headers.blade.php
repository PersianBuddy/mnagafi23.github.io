    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 page-content">
                ...
                <p>
                    این نوع کانکتور‌ها برای اتصال <a href="">پورت‌‌های</a> جلوی <a href="">کیس</a> به <a href="">مادربورد</a> بکار می‌روند.
                </p>
                ...
                <p>
                    هدر <a href="">USB</a> و ۱۳۹۴ کانکتور‌های دارای پین بروی مادربورد هستند، که برای افزودن اتصالات اضافی <a href="">۱۳۹۴</a> و USB به کامپیوتر بکار می‌روند. برای مثال اتصالات USB 2.0 جلوی مادربورد به هدر USB 2.0 مادربورد متصل می‌شوند.
                </p>
                <div class="row">
                    <div class="col-md-6">
                        <figure>
                ...
                <p>
                    همانطور که در تصویر مشاهده می‌کنید، هر دو هدر ۱۳۹۴ و هدر USB 2.0 <b>کاملاً مشابه</b> یکدیگرند و دارای<b> ۹ پین</b> هستند. البته دربرخی از مادربورد‌ها این هدر‌ها دارای ۴ یا ۵ پین نیز می‌باشند (به دفترچه راهنمای مادربورد مراجعه شود).
                </p>
                <p>
                    <span class="glyphicon glyphicon-alert"></span>اتصال کابل هدر USB 2.0 به هدر 1394 مادربورد و بلعکس به مادربورد <b>آسیب</b> می‌رساند.
                </p>
                <h4>هدر USB 3.0</h4>
                ...
                <p>
                    هدر صدا همانند هدر USB یک هدر ۹ پینی است که برای اتصال قطعاتی همچون <a href="">میکروفون</a> و <a href="">هدفون</a> در جلوی مادربورد مورداستفاده قرار می‌گیرد.
                </p>
